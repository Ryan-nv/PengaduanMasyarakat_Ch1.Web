import{b as i}from"../../../../_chunks/chunk-2YYWGCXR.js";import{a as t}from"../../../../_chunks/chunk-SPUUU325.js";import{a as o,c as s,f as d,g as u}from"../../../../_chunks/chunk-FEDAVPE7.js";var n=s(u(),1),r=s(d(),1);$(function(){new e($("#ForgotPasswordPanel"))});var e=class extends n.PropertyPanel{getFormKey(){return i.formKey}constructor(a){super(a),this.byId("SubmitButton").click(m=>{if(m.preventDefault(),!!this.validateForm()){var c=this.getSaveEntity();(0,r.serviceCall)({url:(0,r.resolveUrl)("~/Account/ForgotPassword"),request:c,onSuccess:p=>{(0,r.information)(t.Forms.Membership.ForgotPassword.Success,()=>{window.location.href=(0,r.resolveUrl)("~/")})}})}})}getTemplate(){return`<h2 class="text-center p-4">
    <img src="${(0,r.resolveUrl)("~/Content/site/images/serenity-logo-w-128.png")}"
        class="rounded-circle p-1" style="background-color: var(--s-sidebar-band-bg)"
        width="50" height="50" /> PengaduanMasyarakat
</h2>
